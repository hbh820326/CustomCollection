 ...
 */
public class PinYin {
	int[] pyvalue ={-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
	...
	String[] pystr ={"A", "AI", "AN", "ANG", "AO", "BA", "BAI", "BAN", "BANG", "BAO", "BEI", "BEN", "BENG", "BI", "BIAN",
	...
	public String convert(String str) {
		...
		try {
			if(str.getBytes().length>=2){
				...
				int ascii =256*bytes[0]+bytes[1]+256;//汉字转成ASCII码
				for (int i = (pyvalue.length - 1); i >= 0; i--) {
					if (pyvalue[i] <= ascii) {
						return pystr[i].charAt(0)+"";
					}
				}
			}else{
